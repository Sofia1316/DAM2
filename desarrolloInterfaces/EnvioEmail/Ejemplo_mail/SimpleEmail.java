...
public class SimpleEmail {	
	...
	public static void main(String[] args) {
		...
		final String fromEmail = "patriciiapatp@gmail.com"; //EMAIL DE SALIDA
		final String password = "hgcx gmlb jbso uruw"; //CONTRASEÑA DEL EMAIL DE SALIDA (aplicaciones de 3ros) Contraseñas de aplicación -- Verificación en 2 pasos
		final String toEmail = "patriciiapatp@gmail.com"; // EMAIL DESTINATARIO
